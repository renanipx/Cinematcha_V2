...
const { trendingMovies, isTrendingLoading, fetchTrending, toggleWatchlist, isBookmarked, selectMovie } = useMovies();
const { t, locale } = useLanguage();

onMounted(() => {
  fetchTrending(locale.value);
});
</script>

<template>
  <div class="trending-view animate-fade-in">
    <h2 class="section-title">{{ t('trendingTab') }}</h2>
